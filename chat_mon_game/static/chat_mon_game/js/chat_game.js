$(document).ready(function () {
    ...
    $(".chat-container").scroll(function () {
        ...
        var $chatContainer = $(".chat-container").get(0);
        ...
        var dispacement =
            chat_scrollHeight - chat_scrollTop - chat_clientHeight;
    ...
    function chatInfoTemplateClone(slno, from, text, answered = null) {
        ...
        var templateContent =
            document.querySelector("template#chatInfo").content;
        $(templateContent)
            .find(".newPost .content-info .accountName")
            .text(from);
    ...
    function chatBubbleTemplate(text, classes) {
        var templateContent = document.querySelector(
            "template#chatBubble"
        ).content;
    ...
    function addBubbleClass(slno, classList) {
        var input_info_slno =
            "input[name='info'][chat_data_slno='" + slno + "' ]";
